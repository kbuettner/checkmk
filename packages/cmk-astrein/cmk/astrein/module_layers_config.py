...
_PLUGIN_FAMILIES_WITH_KNOWN_API_VIOLATIONS = {
    ...
    "metric_backend_connector": (
        "cmk.ccc",
        "cmk.dcd.daemon",
        "cmk.dcd.gui",
        "cmk.gui",
        "cmk.metric_backend",
        "cmk.nonfree.ultimate.otel.gui",
...
CMK_UTILS_DEPENDENCIES = {
    ...
    Component("cmk.licensing"): _allow(
        ...
        "cmk.utils.automation_config",  # TYPE_CHECKING only, in license_distribution_registry
    ),
...
COMPONENTS: Mapping[Component, ImportCheckerProtocol] = {
    ...
    Component("cmk.bakery.shared"): _allow(
        *PACKAGE_PLUGIN_APIS,
        *PACKAGE_CCC,
        *PACKAGE_CRYPTO,
    ),
    Component("cmk.bakery.base"): _allow(
        "cmk.bakery",
        "cmk.base.api.bakery",
    ...
    **CMK_UTILS_DEPENDENCIES,
    ...
    Component("tests.integration.cmk.robotmk"): _allow(
        *PACKAGE_CCC,
        "cmk.robotmk",
        "cmk.utils.rulesets",
        "cmk.utils.servicename",
