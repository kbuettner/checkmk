...
def _valuespec_agent_config_citrix_xenapp() -> Dictionary:
    return Dictionary(
        help_text=Help("Deploy the agent plug-in <tt>citrix_xenapp</tt> on your target system."),
        elements={
...
rule_spec_citrix_xenapp = AgentConfig(
    title=Title("Citrix XenApp (Windows)"),
    name="citrix_xenapp",
    topic=Topic.APPLICATIONS,
    parameter_form=_valuespec_agent_config_citrix_xenapp,
)
